...
Stats.prototype.updateTree = function() {
...
Stats.prototype.updateFunctions = function() {
   let datasets  = {typ:[], max:[]};
   let labels    = [];
   let functions = {};
   let i         = 0;
...
Stats.prototype.updateTags = function() {
   let datasets  = {typ:[], max:[]};
   let labels    = [];
   let tags      = {};
   let i         = 0;
...
Stats.prototype.plotChart = function(typmax, dataset, labels, max, unit, clickCallback) {
